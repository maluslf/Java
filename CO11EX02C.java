...
public class CO11EX02C {
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);
        String nomeUsuario = "", clienteMenorAplicacao = "", x="";
        ...
        do {
            System.out.print("Informe o seu nome, ou X para interromper o programa: ");
            nomeUsuario = scanner.nextLine();
            if (nomeUsuario.equalsIgnoreCase("x"))
                break;
